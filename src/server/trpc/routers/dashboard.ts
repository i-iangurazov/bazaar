...
export const dashboardRouter = router({
  bootstrap: managerProcedure.input(dashboardBootstrapInputSchema).query(async ({ ctx, input }) => {
    try {
  ...
  summary: managerProcedure.input(dashboardSummaryInputSchema).query(async ({ ctx, input }) => {
    try {
  ...
  activity: managerProcedure.input(dashboardActivityInputSchema).query(async ({ ctx, input }) => {
    try {
