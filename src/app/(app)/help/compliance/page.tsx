...
const articleIds = ["kkmModes", "exports", "ettnMarking", "periodClose"] as const;

type ArticleId = (typeof articleIds)[number];

const ComplianceHelpPage = () => {
  const t = useTranslations("helpCompliance");
...
export default ComplianceHelpPage;
