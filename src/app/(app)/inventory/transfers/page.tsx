...
const InventoryTransfersPage = () => {
  ...
  const handlePost = () => {
    if (validationMessage || transferMutation.isLoading) {
    ...
    return (
      <div>
        <PageHeader
          ...
          subtitle={t("transferStockSubtitle")}
          action={
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button
                  type="button"
                  onClick={handlePost}
                  disabled={transferMutation.isLoading || Boolean(validationMessage)}
                >
                  ...
                  {transferMutation.isLoading ? tCommon("saving") : t("transferPost")}
                </Button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-[0.8fr_1.2fr] gap-2">
            ...
            >
              ...
              <span className="sm:hidden">
                {transferMutation.isLoading ? tCommon("saving") : t("transferPostShort")}
              </span>
