...
const planCards = [
  ...
  },
  {
    ...
    features: ["до 3 магазинов", "до 5 000 товаров", "касса, импорт и отчёты", "цены по магазинам"],
    cta: "Начать",
    href: "/signup",
    featured: true,
  },
  {
    ...
    features: ["до 10 магазинов", "до 20 000 товаров", "комплаенс и поддержка", "ККМ при настройке"],
    cta: "Запросить демо",
    href: whatsappUrl,
  },
];
