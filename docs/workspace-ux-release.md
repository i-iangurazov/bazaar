...
- Production build — успешно; на собранном HTTPS-пакете повторены **18 сквозных браузерных сценариев**. Проверены реальные ответы и записи штатных сервисов, а не только видимый текст об успехе.
