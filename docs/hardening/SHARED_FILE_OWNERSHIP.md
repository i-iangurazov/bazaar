...
| CLAIMED      | `B2-MIGRATION-1/2` / `HARD-A3-003/004/005/012/021` | Agent 4 | `f0bfa9e4629d696cfcfeb70a0726b2c08e5fd2d4` | `prisma/schema.prisma`, staged additive `prisma/migrations/**`, generated Prisma client contract, collision/backfill scripts and tests | migrate deploy; no-pending proof; schema validation; collision abort; resumable backfill; scoped uniqueness | Agent 3 domain semantics; Agents 1 and 2 cross-review            | pending              |
| CLAIMED      | `B2-OPERATION-REQUESTS` / `HARD-A2-005/006`, `HARD-A3-003/004/012/021` | Agent 3 | `f0bfa9e4629d696cfcfeb70a0726b2c08e5fd2d4` | new `src/server/services/operationRequests.ts` and focused tests; existing `src/server/services/idempotency.ts` explicitly excluded | principal matrix; same-key replay; different-payload conflict; stale lease/reconciliation; bounded secret-free response | Agent 4; Agents 1 and 2 review shared contract                  | pending              |
| CLAIMED      | `B2-INVENTORY-ATOMICITY-COST` / `HARD-A2-007/018` | Agent 2 | `f0bfa9e4629d696cfcfeb70a0726b2c08e5fd2d4` | `src/server/services/inventory.ts`, `src/server/services/productCost.ts`, read-only mismatch detector and focused tests | atomic line-2 failure; `10x5 -> 7x6`; retry/edit/reversal; simple/variant/multi-store valuation | Agent 4; Agent 1 POS and Agent 3 order regression review        | pending              |
