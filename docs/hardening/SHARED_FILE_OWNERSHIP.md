...
| CLAIMED      | `B1-A4-RBAC` / `HARD-A4-001/002/003/004/011`   | Agent 4 | `343079b4e6cd6140f84a8448610259b2d7573704` | `src/lib/roleAccess.ts`, `middleware.ts`, dashboard/analytics/billing/exports/search routers, billing service, `src/components/guidance/guidance-provider.tsx`, global-search service, export download service/route, focused tests | positive and denied role matrix, direct API/download, cross-org/store, no artifact exposure        | Agent 1 or Agent 3                                              | pending              |
